# Bundled Mermaid Rendering Specification

## Purpose

Define how blog post Mermaid diagrams are rendered from project-managed dependencies without relying on runtime CDN module imports.
